...
func (m *OspfArea) validateAuthEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ospfAreaTypeAuthPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *OspfArea) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ospfAreaTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *OspfArea) contextValidateNetworks(ctx context.Context, formats strfmt.Registry) error {
