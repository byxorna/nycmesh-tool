...
func (m *DeviceOutage) validateCategoryEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceOutageTypeCategoryPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceOutage) validateRoleEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceOutageTypeRolePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceOutage) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceOutageTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceOutage) contextValidateSite(ctx context.Context, formats strfmt.Registry) error {
