...
func (m *DeviceSite) validateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceSiteTypeStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceSite) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceSiteTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
