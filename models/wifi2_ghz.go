...
func (m *Wifi2Ghz) validateAuthenticationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi2GhzTypeAuthenticationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wifi2Ghz) validateEncryptionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi2GhzTypeEncryptionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wifi2Ghz) validateModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi2GhzTypeModePropEnum, true); err != nil {
		return err
	}
	return nil
}
