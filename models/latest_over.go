...
func (m *LatestOver) validateMajor(formats strfmt.Registry) error {
...
func (m *LatestOver) validateMinor(formats strfmt.Registry) error {
...
func (m *LatestOver) validateOrder(formats strfmt.Registry) error {
...
func (m *LatestOver) validatePatch(formats strfmt.Registry) error {
...
func (m *LatestOver) validatePrerelease(formats strfmt.Registry) error {
...
// ContextValidate validate this latest over based on the context it is used
...
func (m *LatestOver) contextValidatePrerelease(ctx context.Context, formats strfmt.Registry) error {
