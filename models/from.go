...
func (m *From) contextValidateDevice(ctx context.Context, formats strfmt.Registry) error {
...
func (m *From) contextValidateSite(ctx context.Context, formats strfmt.Registry) error {
