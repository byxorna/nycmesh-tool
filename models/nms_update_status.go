	...
	if m.NmsUpdateError != nil {
		if err := m.NmsUpdateError.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("nmsUpdateError")
			}
			return err
		}
	}
...
func (m *NmsUpdateStatus) validateNmsUpdateStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsUpdateStatusTypeNmsUpdateStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsUpdateStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateNmsUpdateError(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *NmsUpdateStatus) contextValidateNmsUpdateError(ctx context.Context, formats strfmt.Registry) error {

	if m.NmsUpdateError != nil {
		if err := m.NmsUpdateError.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("nmsUpdateError")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("nmsUpdateError")
