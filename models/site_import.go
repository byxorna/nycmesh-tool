...
func (m *SiteImport) validateMacAddresses(formats strfmt.Registry) error {
	...
	if err := m.MacAddresses.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("macAddresses")
		}
		return err
	}
...
func (m *SiteImport) validateRegulatoryDomainEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteImportTypeRegulatoryDomainPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteImport) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteImportTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteImport) contextValidateIPAddresses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteImport) contextValidateMacAddresses(ctx context.Context, formats strfmt.Registry) error {

	if err := m.MacAddresses.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("macAddresses")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("macAddresses")
...
func (m *SiteImport) contextValidateQos(ctx context.Context, formats strfmt.Registry) error {
