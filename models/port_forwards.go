...
// Example: [{"comment":"some comment","enabled":true,"lanAddress":"192.168.3.3","lanPort":[333],"protocol":"tcpudp","wanPort":[334]}]
//
...
func (m PortForwards) Validate(formats strfmt.Registry) error {
	...
	iPortForwardsSize := int64(len(m))

	if err := validate.MinItems("", "body", iPortForwardsSize, 0); err != nil {
		return err
	}
