...
func (m *Model92) validateInterface(formats strfmt.Registry) error {
...
func (m *Model92) validateMtu(formats strfmt.Registry) error {
...
func (m *Model92) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("password", "body", *m.Password, 20); err != nil {
		return err
	}
...
func (m *Model92) validatePppoeID(formats strfmt.Registry) error {
