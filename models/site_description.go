...
func (m *SiteDescription) validateDeviceListStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteDescriptionTypeDeviceListStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteDescription) validateRegulatoryDomainEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteDescriptionTypeRegulatoryDomainPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteDescription) contextValidateContact(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteDescription) contextValidateEndpoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteDescription) contextValidateIPAddresses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteDescription) contextValidateLocation(ctx context.Context, formats strfmt.Registry) error {
