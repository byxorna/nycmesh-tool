...
func (m *Wan) validateProtoEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wanTypeProtoPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wan) contextValidateDNS(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Wan) contextValidateInterfaceNames(ctx context.Context, formats strfmt.Registry) error {
