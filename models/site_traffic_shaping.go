...
func (m *SiteTrafficShaping) validateDownloadBurstSizeEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShapingTypeDownloadBurstSizePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping) validateDownloadSpeedEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShapingTypeDownloadSpeedPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping) validatePropagationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShapingTypePropagationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping) validateUploadBurstSizeEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShapingTypeUploadBurstSizePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping) validateUploadSpeedEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShapingTypeUploadSpeedPropEnum, true); err != nil {
		return err
	}
	return nil
}
