...
func (m *OnuNetwork) validateDownloadLimit(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("downloadLimit", "body", *m.DownloadLimit, 0, false); err != nil {
		return err
	}
...
func (m *OnuNetwork) validateModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, onuNetworkTypeModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *OnuNetwork) validateUploadLimit(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("uploadLimit", "body", *m.UploadLimit, 0, false); err != nil {
		return err
	}
...
func (m *OnuNetwork) validateWanVlan(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("wanVlan", "body", *m.WanVlan, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("wanVlan", "body", *m.WanVlan, 4063, false); err != nil {
		return err
	}
...
func (m *OnuNetwork) contextValidateIPV4(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OnuNetwork) contextValidateIPV6(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OnuNetwork) contextValidatePortForwards(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OnuNetwork) contextValidatePorts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OnuNetwork) contextValidateVlans(ctx context.Context, formats strfmt.Registry) error {
