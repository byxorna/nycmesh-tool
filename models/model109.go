...
func (m *Model109) validateBytes(formats strfmt.Registry) error {
...
func (m *Model109) validateDestination(formats strfmt.Registry) error {
...
func (m *Model109) validateID(formats strfmt.Registry) error {
...
func (m *Model109) validateInInterface(formats strfmt.Registry) error {
...
var model109TypeIPVersionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		model109TypeIPVersionPropEnum = append(model109TypeIPVersionPropEnum, v)
	}
}
...
// prop value enum
func (m *Model109) validateIPVersionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, model109TypeIPVersionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Model109) validateIPVersion(formats strfmt.Registry) error {
...
func (m *Model109) validateOutInterface(formats strfmt.Registry) error {
...
func (m *Model109) validatePackets(formats strfmt.Registry) error {
...
func (m *Model109) validateProtocol(formats strfmt.Registry) error {
...
func (m *Model109) validateSource(formats strfmt.Registry) error {
...
func (m *Model109) validateTarget(formats strfmt.Registry) error {
...
var model109TypeTproxyMarkPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		model109TypeTproxyMarkPropEnum = append(model109TypeTproxyMarkPropEnum, v)
	}
}

// prop value enum
func (m *Model109) validateTproxyMarkEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, model109TypeTproxyMarkPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Model109) validateTproxyMark(formats strfmt.Registry) error {
...
var model109TypeTproxyOnIPPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		model109TypeTproxyOnIPPropEnum = append(model109TypeTproxyOnIPPropEnum, v)
	}
}
...
// prop value enum
func (m *Model109) validateTproxyOnIPEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, model109TypeTproxyOnIPPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Model109) validateTproxyOnIP(formats strfmt.Registry) error {
...
func (m *Model109) validateTproxyOnPort(formats strfmt.Registry) error {
...
func (m *Model109) contextValidateDestination(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Model109) contextValidateInInterface(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Model109) contextValidateOutInterface(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Model109) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {
