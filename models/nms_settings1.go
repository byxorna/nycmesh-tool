...
func (m *NmsSettings1) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDiscoveryBlacklist(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateIsSetupSurveyAnswered(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateOutageMailablePeriod(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NmsSettings1) validateCountryEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeCountryPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateDateFormatEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeDateFormatPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateDefaultGracePeriod(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("defaultGracePeriod", "body", *m.DefaultGracePeriod, 30000, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("defaultGracePeriod", "body", *m.DefaultGracePeriod, 2.592e+09, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateDefaultQosPropagationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeDefaultQosPropagationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateDeviceNumberOfBackups(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("deviceNumberOfBackups", "body", m.DeviceNumberOfBackups, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("deviceNumberOfBackups", "body", m.DeviceNumberOfBackups, 100, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateDevicePingAddressModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeDevicePingAddressModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateDevicePingIntervalNormal(formats strfmt.Registry) error {
	...
	if err := validate.Minimum("devicePingIntervalNormal", "body", *m.DevicePingIntervalNormal, 10000, false); err != nil {
		return err
	}

	if err := validate.Maximum("devicePingIntervalNormal", "body", *m.DevicePingIntervalNormal, 300000, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateDevicePingIntervalOutage(formats strfmt.Registry) error {
	...
	if err := validate.Minimum("devicePingIntervalOutage", "body", *m.DevicePingIntervalOutage, 2000, false); err != nil {
		return err
	}

	if err := validate.Maximum("devicePingIntervalOutage", "body", *m.DevicePingIntervalOutage, 300000, false); err != nil {
		return err
	}
	...
	if m.DeviceTransmissionFrequencies != nil {
		if err := m.DeviceTransmissionFrequencies.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("deviceTransmissionFrequencies")
			}
			return err
		}
	}
...
func (m *NmsSettings1) validateDeviceTransmissionProfileEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeDeviceTransmissionProfilePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateDiscoveryBlacklist(formats strfmt.Registry) error {
	if swag.IsZero(m.DiscoveryBlacklist) { // not required
		return nil
	}

	if err := m.DiscoveryBlacklist.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("discoveryBlacklist")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("discoveryBlacklist")
		}
		return err
	}
...
func (m *NmsSettings1) validateHomePageEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeHomePagePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateIsSetupSurveyAnswered(formats strfmt.Registry) error {

	if err := validate.Required("isSetupSurveyAnswered", "body", m.IsSetupSurveyAnswered); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateMaintenanceWindowFromTime(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("maintenanceWindowFromTime", "body", *m.MaintenanceWindowFromTime, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("maintenanceWindowFromTime", "body", *m.MaintenanceWindowFromTime, 24, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateMaintenanceWindowToTime(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("maintenanceWindowToTime", "body", *m.MaintenanceWindowToTime, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("maintenanceWindowToTime", "body", *m.MaintenanceWindowToTime, 24, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateMapsProviderEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeMapsProviderPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateMigrationPort(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("migrationPort", "body", *m.MigrationPort, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("migrationPort", "body", *m.MigrationPort, 65535, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateOutageMailablePeriod(formats strfmt.Registry) error {

	if err := validate.Required("outageMailablePeriod", "body", m.OutageMailablePeriod); err != nil {
		return err
	}

	if err := validate.MinimumInt("outageMailablePeriod", "body", *m.OutageMailablePeriod, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("outageMailablePeriod", "body", *m.OutageMailablePeriod, 8.64e+07, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateRestartGracePeriod(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("restartGracePeriod", "body", *m.RestartGracePeriod, 30000, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("restartGracePeriod", "body", *m.RestartGracePeriod, 2.592e+09, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateTimeFormatEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeTimeFormatPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateTimezoneEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, nmsSettings1TypeTimezonePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *NmsSettings1) validateTrafficShapingAdjustment(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("trafficShapingAdjustment", "body", m.TrafficShapingAdjustment, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("trafficShapingAdjustment", "body", m.TrafficShapingAdjustment, 100, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) validateUpgradeGracePeriod(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("upgradeGracePeriod", "body", *m.UpgradeGracePeriod, 30000, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("upgradeGracePeriod", "body", *m.UpgradeGracePeriod, 2.592e+09, false); err != nil {
		return err
	}
...
func (m *NmsSettings1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDeviceTransmissionFrequencies(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateDiscoveryBlacklist(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *NmsSettings1) contextValidateDeviceTransmissionFrequencies(ctx context.Context, formats strfmt.Registry) error {

	if m.DeviceTransmissionFrequencies != nil {
		if err := m.DeviceTransmissionFrequencies.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deviceTransmissionFrequencies")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deviceTransmissionFrequencies")
...
func (m *NmsSettings1) contextValidateDiscoveryBlacklist(ctx context.Context, formats strfmt.Registry) error {

	if err := m.DiscoveryBlacklist.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("discoveryBlacklist")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("discoveryBlacklist")
