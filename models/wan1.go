...
func (m *Wan1) validatePppoeModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wan1TypePppoeModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wan1) validateWanModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wan1TypeWanModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wan1) contextValidateDNSResolvers(ctx context.Context, formats strfmt.Registry) error {
