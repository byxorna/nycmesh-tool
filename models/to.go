...
func (m *To) contextValidateDevice(ctx context.Context, formats strfmt.Registry) error {
...
func (m *To) contextValidateSite(ctx context.Context, formats strfmt.Registry) error {
