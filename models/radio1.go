...
func (m *Radio1) validateAntennaList(formats strfmt.Registry) error {
	...
	if err := m.AntennaList.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("antennaList")
		}
		return err
	}
...
func (m *Radio1) validateChannelWidthList(formats strfmt.Registry) error {
	...
	if err := m.ChannelWidthList.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("channelWidthList")
		}
		return err
	}
...
func (m *Radio1) validateSupportedBands(formats strfmt.Registry) error {
	...
	if err := m.SupportedBands.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("supportedBands")
		}
		return err
	}
...
func (m *Radio1) validateSupportedIeeeStandards(formats strfmt.Registry) error {
	...
	if err := m.SupportedIeeeStandards.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("supportedIeeeStandards")
		}
		return err
	}
	...
	if m.TxPowerRange != nil {
		if err := m.TxPowerRange.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("txPowerRange")
			}
			return err
		}
	}
...
func (m *Radio1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAntennaList(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateChannelWidthList(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSupportedBands(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSupportedIeeeStandards(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateTxPowerRange(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Radio1) contextValidateAntennaList(ctx context.Context, formats strfmt.Registry) error {

	if err := m.AntennaList.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("antennaList")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("antennaList")
...
func (m *Radio1) contextValidateChannelWidthList(ctx context.Context, formats strfmt.Registry) error {

	if err := m.ChannelWidthList.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("channelWidthList")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("channelWidthList")
...
func (m *Radio1) contextValidateSupportedBands(ctx context.Context, formats strfmt.Registry) error {

	if err := m.SupportedBands.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("supportedBands")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("supportedBands")
...
func (m *Radio1) contextValidateSupportedIeeeStandards(ctx context.Context, formats strfmt.Registry) error {

	if err := m.SupportedIeeeStandards.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("supportedIeeeStandards")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("supportedIeeeStandards")
...
func (m *Radio1) contextValidateTxPowerRange(ctx context.Context, formats strfmt.Registry) error {

	if m.TxPowerRange != nil {
		if err := m.TxPowerRange.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("txPowerRange")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("txPowerRange")
