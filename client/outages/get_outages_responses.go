...
/* GetOutagesOK describes a response with status code 200, with default header values.
...
/* GetOutagesBadRequest describes a response with status code 400, with default header values.
...
/* GetOutagesUnauthorized describes a response with status code 401, with default header values.
...
/* GetOutagesForbidden describes a response with status code 403, with default header values.
...
/* GetOutagesNotFound describes a response with status code 404, with default header values.
...
/* GetOutagesInternalServerError describes a response with status code 500, with default header values.
