...
func (a *Client) GetNmsTraffic(params *GetNmsTrafficParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNmsTrafficOK, error) {
	...
	if params == nil {
		params = NewGetNmsTrafficParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getNmsTraffic",
		Method:             "GET",
		PathPattern:        "/nms/traffic",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetNmsTrafficReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetNmsTrafficOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getNmsTraffic: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
