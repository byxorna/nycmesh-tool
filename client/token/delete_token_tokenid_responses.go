...
func (o *DeleteTokenTokenidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return nil, result
	case 409:
		result := NewDeleteTokenTokenidConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDeleteTokenTokenidConflict() *DeleteTokenTokenidConflict {
	return &DeleteTokenTokenidConflict{}
}
...
func (o *DeleteTokenTokenidConflict) Error() string {
	return fmt.Sprintf("[DELETE /token/{tokenId}][%d] deleteTokenTokenidConflict  %+v", 409, o.Payload)
}
func (o *DeleteTokenTokenidConflict) GetPayload() *models.Error {
	return o.Payload
}

func (o *DeleteTokenTokenidConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
