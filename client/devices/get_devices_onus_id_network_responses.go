...
/* GetDevicesOnusIDNetworkOK describes a response with status code 200, with default header values.
...
/* GetDevicesOnusIDNetworkBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesOnusIDNetworkUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesOnusIDNetworkForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesOnusIDNetworkNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesOnusIDNetworkInternalServerError describes a response with status code 500, with default header values.
