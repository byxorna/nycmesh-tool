...
/* PostDevicesDeviceidInterfacesEnablelagOK describes a response with status code 200, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagInternalServerError describes a response with status code 500, with default header values.
...
/* PostDevicesDeviceidInterfacesEnablelagNotImplemented describes a response with status code 501, with default header values.
