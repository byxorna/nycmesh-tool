...
/* PostDevicesIDAuthorizeOK describes a response with status code 200, with default header values.
...
/* PostDevicesIDAuthorizeBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesIDAuthorizeUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesIDAuthorizeForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesIDAuthorizeInternalServerError describes a response with status code 500, with default header values.
