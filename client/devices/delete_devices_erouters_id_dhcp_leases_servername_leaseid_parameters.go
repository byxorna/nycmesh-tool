...
/* DeleteDevicesEroutersIDDhcpLeasesServernameLeaseidParams contains all the parameters to send to the API endpoint
   for the delete devices erouters Id dhcp leases servername leaseid operation.
...
// WithDefaults hydrates default values in the delete devices erouters Id dhcp leases servername leaseid params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDevicesEroutersIDDhcpLeasesServernameLeaseidParams) WithDefaults() *DeleteDevicesEroutersIDDhcpLeasesServernameLeaseidParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete devices erouters Id dhcp leases servername leaseid params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDevicesEroutersIDDhcpLeasesServernameLeaseidParams) SetDefaults() {
