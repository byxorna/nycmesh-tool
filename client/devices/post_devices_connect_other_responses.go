...
/* PostDevicesConnectOtherOK describes a response with status code 200, with default header values.
...
/* PostDevicesConnectOtherBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesConnectOtherUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesConnectOtherNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesConnectOtherInternalServerError describes a response with status code 500, with default header values.
