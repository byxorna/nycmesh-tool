...
/* GetDevicesEroutersIDDhcpLeasesOK describes a response with status code 200, with default header values.

Successful
*/
type GetDevicesEroutersIDDhcpLeasesOK struct {
	Payload models.DHCPLeaseList
}
...
func (o *GetDevicesEroutersIDDhcpLeasesOK) GetPayload() models.DHCPLeaseList {
	return o.Payload
}
...
/* GetDevicesEroutersIDDhcpLeasesBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEroutersIDDhcpLeasesUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEroutersIDDhcpLeasesForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEroutersIDDhcpLeasesNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEroutersIDDhcpLeasesInternalServerError describes a response with status code 500, with default header values.
