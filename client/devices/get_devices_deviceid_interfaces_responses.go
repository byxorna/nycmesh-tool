...
/* GetDevicesDeviceidInterfacesOK describes a response with status code 200, with default header values.
...
/* GetDevicesDeviceidInterfacesBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesDeviceidInterfacesUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesDeviceidInterfacesForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesDeviceidInterfacesNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesDeviceidInterfacesInternalServerError describes a response with status code 500, with default header values.
