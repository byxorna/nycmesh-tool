...
/* PutDevicesOltsIDOnuPoliciesOK describes a response with status code 200, with default header values.
...
/* PutDevicesOltsIDOnuPoliciesBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesOltsIDOnuPoliciesUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesOltsIDOnuPoliciesForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesOltsIDOnuPoliciesNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesOltsIDOnuPoliciesInternalServerError describes a response with status code 500, with default header values.
