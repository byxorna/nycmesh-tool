...
/* PutDevicesBlackboxesIDConfigOK describes a response with status code 200, with default header values.
...
/* PutDevicesBlackboxesIDConfigBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesBlackboxesIDConfigUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesBlackboxesIDConfigForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesBlackboxesIDConfigNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesBlackboxesIDConfigConflict describes a response with status code 409, with default header values.
...
/* PutDevicesBlackboxesIDConfigInternalServerError describes a response with status code 500, with default header values.
