...
/* GetAirlinkProxyAirlinkbeOK describes a response with status code 200, with default header values.
...
/* GetAirlinkProxyAirlinkbeBadRequest describes a response with status code 400, with default header values.
...
/* GetAirlinkProxyAirlinkbeUnauthorized describes a response with status code 401, with default header values.
...
/* GetAirlinkProxyAirlinkbeForbidden describes a response with status code 403, with default header values.
...
/* GetAirlinkProxyAirlinkbeInternalServerError describes a response with status code 500, with default header values.
...
/* GetAirlinkProxyAirlinkbeBadGateway describes a response with status code 502, with default header values.
