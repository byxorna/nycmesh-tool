...
/* PutDevicesEroutersIDDhcpServersServernameOK describes a response with status code 200, with default header values.
...
/* PutDevicesEroutersIDDhcpServersServernameBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesEroutersIDDhcpServersServernameUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesEroutersIDDhcpServersServernameForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesEroutersIDDhcpServersServernameNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesEroutersIDDhcpServersServernameInternalServerError describes a response with status code 500, with default header values.
