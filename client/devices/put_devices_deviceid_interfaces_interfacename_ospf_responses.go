...
/* PutDevicesDeviceidInterfacesInterfacenameOspfOK describes a response with status code 200, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameOspfBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameOspfUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameOspfForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameOspfNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameOspfInternalServerError describes a response with status code 500, with default header values.
