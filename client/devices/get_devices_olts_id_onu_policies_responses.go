...
/* GetDevicesOltsIDOnuPoliciesOK describes a response with status code 200, with default header values.
...
/* GetDevicesOltsIDOnuPoliciesBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesOltsIDOnuPoliciesUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesOltsIDOnuPoliciesForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesOltsIDOnuPoliciesNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesOltsIDOnuPoliciesInternalServerError describes a response with status code 500, with default header values.
