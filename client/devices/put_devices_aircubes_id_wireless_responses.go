...
/* PutDevicesAircubesIDWirelessOK describes a response with status code 200, with default header values.
...
/* PutDevicesAircubesIDWirelessBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesAircubesIDWirelessUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesAircubesIDWirelessForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesAircubesIDWirelessNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesAircubesIDWirelessInternalServerError describes a response with status code 500, with default header values.
