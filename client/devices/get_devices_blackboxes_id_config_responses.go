...
/* GetDevicesBlackboxesIDConfigOK describes a response with status code 200, with default header values.
...
/* GetDevicesBlackboxesIDConfigBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesBlackboxesIDConfigUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesBlackboxesIDConfigForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesBlackboxesIDConfigNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesBlackboxesIDConfigInternalServerError describes a response with status code 500, with default header values.
