...
/* GetDevicesEroutersIDDhcpServersOK describes a response with status code 200, with default header values.
...
/* GetDevicesEroutersIDDhcpServersBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEroutersIDDhcpServersUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEroutersIDDhcpServersForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEroutersIDDhcpServersNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEroutersIDDhcpServersInternalServerError describes a response with status code 500, with default header values.
