...
/* PutDevicesAirmaxesIDConfigWirelessOK describes a response with status code 200, with default header values.
...
/* PutDevicesAirmaxesIDConfigWirelessBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesAirmaxesIDConfigWirelessUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesAirmaxesIDConfigWirelessForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesAirmaxesIDConfigWirelessNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesAirmaxesIDConfigWirelessInternalServerError describes a response with status code 500, with default header values.
