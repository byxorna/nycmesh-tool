...
/* GetDevicesEswitchesIDOK describes a response with status code 200, with default header values.
...
/* GetDevicesEswitchesIDBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEswitchesIDUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEswitchesIDForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEswitchesIDNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEswitchesIDInternalServerError describes a response with status code 500, with default header values.
