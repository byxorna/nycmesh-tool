...
/* DeleteDevicesDeviceidInterfacesInterfacenameOK describes a response with status code 200, with default header values.
...
/* DeleteDevicesDeviceidInterfacesInterfacenameBadRequest describes a response with status code 400, with default header values.
...
/* DeleteDevicesDeviceidInterfacesInterfacenameUnauthorized describes a response with status code 401, with default header values.
...
/* DeleteDevicesDeviceidInterfacesInterfacenameForbidden describes a response with status code 403, with default header values.
...
/* DeleteDevicesDeviceidInterfacesInterfacenameNotFound describes a response with status code 404, with default header values.
...
/* DeleteDevicesDeviceidInterfacesInterfacenameInternalServerError describes a response with status code 500, with default header values.
