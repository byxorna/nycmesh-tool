...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidOK describes a response with status code 200, with default header values.
...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidInternalServerError describes a response with status code 500, with default header values.
