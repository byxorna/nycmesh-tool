...
/* PostDevicesAuthorizeOK describes a response with status code 200, with default header values.
...
/* PostDevicesAuthorizeBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesAuthorizeUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesAuthorizeForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesAuthorizeInternalServerError describes a response with status code 500, with default header values.
