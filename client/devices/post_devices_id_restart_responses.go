...
/* PostDevicesIDRestartOK describes a response with status code 200, with default header values.
...
/* PostDevicesIDRestartBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesIDRestartUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesIDRestartForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesIDRestartInternalServerError describes a response with status code 500, with default header values.
