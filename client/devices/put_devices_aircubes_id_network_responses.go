...
/* PutDevicesAircubesIDNetworkOK describes a response with status code 200, with default header values.
...
/* PutDevicesAircubesIDNetworkBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesAircubesIDNetworkUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesAircubesIDNetworkForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesAircubesIDNetworkNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesAircubesIDNetworkInternalServerError describes a response with status code 500, with default header values.
