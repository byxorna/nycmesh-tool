...
/* GetDevicesOltsIDOK describes a response with status code 200, with default header values.
...
/* GetDevicesOltsIDBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesOltsIDUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesOltsIDForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesOltsIDNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesOltsIDInternalServerError describes a response with status code 500, with default header values.
