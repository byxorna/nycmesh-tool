...
/* GetDevicesAircubesIDNetworkOK describes a response with status code 200, with default header values.
...
/* GetDevicesAircubesIDNetworkBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesAircubesIDNetworkUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesAircubesIDNetworkForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesAircubesIDNetworkNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesAircubesIDNetworkInternalServerError describes a response with status code 500, with default header values.
