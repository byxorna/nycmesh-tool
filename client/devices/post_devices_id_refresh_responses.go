...
/* PostDevicesIDRefreshOK describes a response with status code 200, with default header values.
...
/* PostDevicesIDRefreshBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesIDRefreshUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesIDRefreshForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesIDRefreshInternalServerError describes a response with status code 500, with default header values.
