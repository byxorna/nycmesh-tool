...
/* GetDevicesAircubesIDStationsOK describes a response with status code 200, with default header values.
...
func (o *GetDevicesAircubesIDStationsOK) GetPayload() models.Model39 {
	return o.Payload
}
...
/* GetDevicesAircubesIDStationsBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesAircubesIDStationsUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesAircubesIDStationsForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesAircubesIDStationsNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesAircubesIDStationsInternalServerError describes a response with status code 500, with default header values.
