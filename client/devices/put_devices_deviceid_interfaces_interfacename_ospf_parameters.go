...
/* PutDevicesDeviceidInterfacesInterfacenameOspfParams contains all the parameters to send to the API endpoint
   for the put devices deviceid interfaces interfacename ospf operation.
...
// WithDefaults hydrates default values in the put devices deviceid interfaces interfacename ospf params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesDeviceidInterfacesInterfacenameOspfParams) WithDefaults() *PutDevicesDeviceidInterfacesInterfacenameOspfParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put devices deviceid interfaces interfacename ospf params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesDeviceidInterfacesInterfacenameOspfParams) SetDefaults() {
...
func (o *PutDevicesDeviceidInterfacesInterfacenameOspfParams) WithBody(body *models.Model125) *PutDevicesDeviceidInterfacesInterfacenameOspfParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices deviceid interfaces interfacename ospf params
func (o *PutDevicesDeviceidInterfacesInterfacenameOspfParams) SetBody(body *models.Model125) {
	o.Body = body
}
