...
/* PatchDevicesDeviceidUdapiVersionUdapiurlOK describes a response with status code 200, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlBadRequest describes a response with status code 400, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlUnauthorized describes a response with status code 401, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlForbidden describes a response with status code 403, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlNotFound describes a response with status code 404, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlInternalServerError describes a response with status code 500, with default header values.
...
/* PatchDevicesDeviceidUdapiVersionUdapiurlNotImplemented describes a response with status code 501, with default header values.
