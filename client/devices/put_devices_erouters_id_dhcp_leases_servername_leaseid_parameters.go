...
/* PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams contains all the parameters to send to the API endpoint
   for the put devices erouters Id dhcp leases servername leaseid operation.
...
// WithDefaults hydrates default values in the put devices erouters Id dhcp leases servername leaseid params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams) WithDefaults() *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put devices erouters Id dhcp leases servername leaseid params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams) SetDefaults() {
...
func (o *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams) WithBody(body *models.DHCPLease2) *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices erouters Id dhcp leases servername leaseid params
func (o *PutDevicesEroutersIDDhcpLeasesServernameLeaseidParams) SetBody(body *models.DHCPLease2) {
	o.Body = body
}
