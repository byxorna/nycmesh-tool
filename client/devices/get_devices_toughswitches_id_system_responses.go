...
/* GetDevicesToughswitchesIDSystemOK describes a response with status code 200, with default header values.
...
func (o *GetDevicesToughswitchesIDSystemOK) GetPayload() *models.Model41 {
	return o.Payload
}
...
/* GetDevicesToughswitchesIDSystemBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesToughswitchesIDSystemUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesToughswitchesIDSystemForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesToughswitchesIDSystemNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesToughswitchesIDSystemInternalServerError describes a response with status code 500, with default header values.
