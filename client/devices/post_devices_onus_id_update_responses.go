...
/* PostDevicesOnusIDUpdateOK describes a response with status code 200, with default header values.
...
/* PostDevicesOnusIDUpdateBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesOnusIDUpdateUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesOnusIDUpdateForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesOnusIDUpdateNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesOnusIDUpdateInternalServerError describes a response with status code 500, with default header values.
