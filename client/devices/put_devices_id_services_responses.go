...
/* PutDevicesIDServicesOK describes a response with status code 200, with default header values.
...
/* PutDevicesIDServicesBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesIDServicesUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesIDServicesForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesIDServicesNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesIDServicesInternalServerError describes a response with status code 500, with default header values.
