...
/* GetDevicesOnusIDOK describes a response with status code 200, with default header values.
...
/* GetDevicesOnusIDBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesOnusIDUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesOnusIDForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesOnusIDInternalServerError describes a response with status code 500, with default header values.
