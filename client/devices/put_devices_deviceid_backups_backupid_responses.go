...
/* PutDevicesDeviceidBackupsBackupidBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesDeviceidBackupsBackupidUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesDeviceidBackupsBackupidForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesDeviceidBackupsBackupidNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesDeviceidBackupsBackupidInternalServerError describes a response with status code 500, with default header values.
