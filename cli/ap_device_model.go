...
// Schema cli for ApDevice

// register flags to command
func registerModelApDeviceFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerApDeviceID(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerApDeviceModel(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerApDeviceName(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerApDeviceSeries(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerApDeviceType(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerApDeviceID(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerApDeviceModel(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerApDeviceName(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerApDeviceSeries(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerApDeviceType(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelApDeviceFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, idAdded := retrieveApDeviceIDFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || idAdded

	err, modelAdded := retrieveApDeviceModelFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || modelAdded

	err, nameAdded := retrieveApDeviceNameFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || nameAdded

	err, seriesAdded := retrieveApDeviceSeriesFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || seriesAdded

	err, typeAdded := retrieveApDeviceTypeFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveApDeviceIDFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveApDeviceModelFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveApDeviceNameFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveApDeviceSeriesFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveApDeviceTypeFlags(depth int, m *models.ApDevice, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
