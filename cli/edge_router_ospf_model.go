...
// Schema cli for EdgeRouterOspf

// register flags to command
func registerModelEdgeRouterOspfFlags(depth int, cmdPrefix string, cmd *cobra.Command) error {

	if err := registerEdgeRouterOspfRedistributeConnected(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerEdgeRouterOspfRedistributeDefaultRoute(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerEdgeRouterOspfRedistributeStatic(depth, cmdPrefix, cmd); err != nil {
		return err
	}

	if err := registerEdgeRouterOspfRouter(depth, cmdPrefix, cmd); err != nil {
		return err
	}
...
func registerEdgeRouterOspfRedistributeConnected(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerEdgeRouterOspfRedistributeDefaultRoute(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerEdgeRouterOspfRedistributeStatic(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func registerEdgeRouterOspfRouter(depth int, cmdPrefix string, cmd *cobra.Command) error {
	if depth > maxDepth {
		return nil
	}
...
func retrieveModelEdgeRouterOspfFlags(depth int, m *models.EdgeRouterOspf, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	retAdded := false

	err, redistributeConnectedAdded := retrieveEdgeRouterOspfRedistributeConnectedFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || redistributeConnectedAdded

	err, redistributeDefaultRouteAdded := retrieveEdgeRouterOspfRedistributeDefaultRouteFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || redistributeDefaultRouteAdded

	err, redistributeStaticAdded := retrieveEdgeRouterOspfRedistributeStaticFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
	retAdded = retAdded || redistributeStaticAdded

	err, routerAdded := retrieveEdgeRouterOspfRouterFlags(depth, m, cmdPrefix, cmd)
	if err != nil {
		return err, false
	}
...
func retrieveEdgeRouterOspfRedistributeConnectedFlags(depth int, m *models.EdgeRouterOspf, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveEdgeRouterOspfRedistributeDefaultRouteFlags(depth int, m *models.EdgeRouterOspf, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveEdgeRouterOspfRedistributeStaticFlags(depth int, m *models.EdgeRouterOspf, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
...
func retrieveEdgeRouterOspfRouterFlags(depth int, m *models.EdgeRouterOspf, cmdPrefix string, cmd *cobra.Command) (error, bool) {
	if depth > maxDepth {
		return nil, false
	}
	retAdded := false
