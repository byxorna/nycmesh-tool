...
// SouthEastCorner GPS coordinates South-East corner of the coverage.
...
func (m *SouthEastCorner) validateLatitude(formats strfmt.Registry) error {
...
func (m *SouthEastCorner) validateLongitude(formats strfmt.Registry) error {
