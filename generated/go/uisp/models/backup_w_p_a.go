...
func (m *BackupWPA) validateEapTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, backupWPATypeEapTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *BackupWPA) validateEapTypeExtEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, backupWPATypeEapTypeExtPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *BackupWPA) validateSecurityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, backupWPATypeSecurityPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *BackupWPA) validateWpaAuthenticationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, backupWPATypeWpaAuthenticationPropEnum, true); err != nil {
		return err
	}
	return nil
}
