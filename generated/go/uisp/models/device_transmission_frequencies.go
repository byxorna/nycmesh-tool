...
func (m *DeviceTransmissionFrequencies) validateApEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeApPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateGponEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeGponPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateOtherEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeOtherPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateRouterEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeRouterPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateStationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeStationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateSwitchEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeSwitchPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceTransmissionFrequencies) validateUpsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceTransmissionFrequenciesTypeUpsPropEnum, true); err != nil {
		return err
	}
	return nil
}
