...
func (m *SMTP) validateCustomSMTPPort(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("customSmtpPort", "body", *m.CustomSMTPPort, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("customSmtpPort", "body", *m.CustomSMTPPort, 65535, false); err != nil {
		return err
	}
...
func (m *SMTP) validateCustomSMTPSecurityModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, smtpTypeCustomSMTPSecurityModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SMTP) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, smtpTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
