...
func (m *Lan2) validateLanMode6Enum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, lan2TypeLanMode6PropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Lan2) validateRouterAdvertisementModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, lan2TypeRouterAdvertisementModePropEnum, true); err != nil {
		return err
	}
	return nil
}
