...
func (m *BulkDeleteDevices) contextValidateDeletedIds(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BulkDeleteDevices) contextValidateUndeletedIds(ctx context.Context, formats strfmt.Registry) error {
