	...
	if m.LedNightMode != nil {
		if err := m.LedNightMode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("ledNightMode")
			}
			return err
		}
	}
...
func (m *AirCubeSystemConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateLedNightMode(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AirCubeSystemConfig) contextValidateLedNightMode(ctx context.Context, formats strfmt.Registry) error {

	if m.LedNightMode != nil {
		if err := m.LedNightMode.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ledNightMode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ledNightMode")
