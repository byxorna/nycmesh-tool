...
func (m *Lan1) validateDhcpLeaseTime(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("dhcpLeaseTime", "body", *m.DhcpLeaseTime, 1, false); err != nil {
		return err
	}
...
func (m *Lan1) validateDhcpServerModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, lan1TypeDhcpServerModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Lan1) validateDNSResolvers(formats strfmt.Registry) error {
	if swag.IsZero(m.DNSResolvers) { // not required
		return nil
	}
	...
	if err := m.DNSResolvers.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("dnsResolvers")
		}
		return err
	}
...
func (m *Lan1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDNSResolvers(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Lan1) contextValidateDNSResolvers(ctx context.Context, formats strfmt.Registry) error {

	if err := m.DNSResolvers.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("dnsResolvers")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("dnsResolvers")
