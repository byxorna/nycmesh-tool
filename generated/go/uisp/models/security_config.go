	...
	if m.BackupWPA != nil {
		if err := m.BackupWPA.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("backupWPA")
			}
			return err
		}
	}
...
func (m *SecurityConfig) validateEapTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, securityConfigTypeEapTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SecurityConfig) validateEapTypeExtEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, securityConfigTypeEapTypeExtPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SecurityConfig) validateSecurityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, securityConfigTypeSecurityPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SecurityConfig) validateWpaAuthenticationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, securityConfigTypeWpaAuthenticationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SecurityConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBackupWPA(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SecurityConfig) contextValidateBackupWPA(ctx context.Context, formats strfmt.Registry) error {

	if m.BackupWPA != nil {
		if err := m.BackupWPA.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("backupWPA")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("backupWPA")
