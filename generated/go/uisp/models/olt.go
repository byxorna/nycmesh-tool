...
func (m *Olt) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateLayer2(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Olt) contextValidateLayer2(ctx context.Context, formats strfmt.Registry) error {

	if m.Layer2 != nil {
		if err := m.Layer2.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("layer2")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("layer2")
