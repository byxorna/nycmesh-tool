...
func (m *AirMaxWifiConfig) validateAllowedFrequencies(formats strfmt.Registry) error {
	...
	if err := m.AllowedFrequencies.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("allowedFrequencies")
		}
		return err
	}
...
func (m *AirMaxWifiConfig) validateApMac(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("apMac", "body", *m.ApMac, `^([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F])$|^([0-9a-fA-F]){12}$`); err != nil {
		return err
	}
...
func (m *AirMaxWifiConfig) validateBandEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, airMaxWifiConfigTypeBandPropEnum, true); err != nil {
		return err
	}
	return nil
}
	...
	if m.BoardInfo != nil {
		if err := m.BoardInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("boardInfo")
			}
			return err
		}
	}
...
func (m *AirMaxWifiConfig) validateExtensionChannelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, airMaxWifiConfigTypeExtensionChannelPropEnum, true); err != nil {
		return err
	}
	return nil
}
	...
	if m.MacACLConfig != nil {
		if err := m.MacACLConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("macACLConfig")
			}
			return err
		}
	}
...
func (m *AirMaxWifiConfig) validateModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, airMaxWifiConfigTypeModePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *AirMaxWifiConfig) validateRegulatoryDomainBands(formats strfmt.Registry) error {
	...
	if err := m.RegulatoryDomainBands.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("regulatoryDomainBands")
		}
		return err
	}
...
func (m *AirMaxWifiConfig) validateRegulatoryDomainChannels(formats strfmt.Registry) error {
	...
	if err := m.RegulatoryDomainChannels.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("regulatoryDomainChannels")
		}
		return err
	}
	...
	if m.SecurityConfig != nil {
		if err := m.SecurityConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("securityConfig")
			}
			return err
		}
	}
...
func (m *AirMaxWifiConfig) validateSyncModeEnum(path, location string, value float64) error {
	if err := validate.EnumCase(path, location, value, airMaxWifiConfigTypeSyncModePropEnum, true); err != nil {
		return err
	}
	return nil
}
	...
	if m.TddFraming != nil {
		if err := m.TddFraming.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("tddFraming")
			}
			return err
		}
	}
...
func (m *AirMaxWifiConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAllowedFrequencies(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateBoardInfo(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateMacACLConfig(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateRegulatoryDomainBands(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateRegulatoryDomainChannels(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateTddFraming(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AirMaxWifiConfig) contextValidateAllowedFrequencies(ctx context.Context, formats strfmt.Registry) error {

	if err := m.AllowedFrequencies.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("allowedFrequencies")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("allowedFrequencies")
...
func (m *AirMaxWifiConfig) contextValidateBoardInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.BoardInfo != nil {
		if err := m.BoardInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("boardInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("boardInfo")
...
func (m *AirMaxWifiConfig) contextValidateMacACLConfig(ctx context.Context, formats strfmt.Registry) error {

	if m.MacACLConfig != nil {
		if err := m.MacACLConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("macACLConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("macACLConfig")
...
func (m *AirMaxWifiConfig) contextValidateRegulatoryDomainBands(ctx context.Context, formats strfmt.Registry) error {

	if err := m.RegulatoryDomainBands.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("regulatoryDomainBands")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("regulatoryDomainBands")
...
func (m *AirMaxWifiConfig) contextValidateRegulatoryDomainChannels(ctx context.Context, formats strfmt.Registry) error {

	if err := m.RegulatoryDomainChannels.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("regulatoryDomainChannels")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("regulatoryDomainChannels")
...
func (m *AirMaxWifiConfig) contextValidateSecurityConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AirMaxWifiConfig) contextValidateTddFraming(ctx context.Context, formats strfmt.Registry) error {

	if m.TddFraming != nil {
		if err := m.TddFraming.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("tddFraming")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("tddFraming")
