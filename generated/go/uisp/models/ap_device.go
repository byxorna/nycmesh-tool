...
var apDeviceTypeSeriesPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		apDeviceTypeSeriesPropEnum = append(apDeviceTypeSeriesPropEnum, v)
	}
}
...
// prop value enum
func (m *ApDevice) validateSeriesEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, apDeviceTypeSeriesPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ApDevice) validateSeries(formats strfmt.Registry) error {
