...
func (m *CreateSite) validateRegulatoryDomainEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createSiteTypeRegulatoryDomainPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *CreateSite) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createSiteTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *CreateSite) contextValidateLocation(ctx context.Context, formats strfmt.Registry) error {
