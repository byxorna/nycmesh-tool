...
func (m *DeviceBlackBoxConfig) validateDeviceRoleEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceBlackBoxConfigTypeDeviceRolePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceBlackBoxConfig) validateMacAddress(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("macAddress", "body", m.MacAddress, `^([0-9a-fA-F][0-9a-fA-F]:){5}([0-9a-fA-F][0-9a-fA-F])$|^([0-9a-fA-F]){12}$`); err != nil {
		return err
	}
...
func (m *DeviceBlackBoxConfig) validateModelName(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("modelName", "body", m.ModelName, 50); err != nil {
		return err
	}
	...
	if m.UbntData != nil {
		if err := m.UbntData.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("ubntData")
			}
			return err
		}
	}
...
func (m *DeviceBlackBoxConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateUbntData(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DeviceBlackBoxConfig) contextValidateInterfaces(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DeviceBlackBoxConfig) contextValidateUbntData(ctx context.Context, formats strfmt.Registry) error {

	if m.UbntData != nil {
		if err := m.UbntData.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ubntData")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ubntData")
