...
func (m *PayloadUnmsSettings) validateDeviceGracePeriodOutage(formats strfmt.Registry) error {
	...
	if err := validate.Minimum("deviceGracePeriodOutage", "body", m.DeviceGracePeriodOutage, 30000, false); err != nil {
		return err
	}

	if err := validate.Maximum("deviceGracePeriodOutage", "body", m.DeviceGracePeriodOutage, 2.592e+09, false); err != nil {
		return err
	}
...
func (m *PayloadUnmsSettings) validateDeviceTransmissionFrequencyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, payloadUnmsSettingsTypeDeviceTransmissionFrequencyPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *PayloadUnmsSettings) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
