...
func (m *DeviceImport) validateDeviceRoleEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deviceImportTypeDeviceRolePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *DeviceImport) validateHTTPSPort(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("httpsPort", "body", m.HTTPSPort, 1, false); err != nil {
		return err
	}
...
func (m *DeviceImport) contextValidateInterfaces(ctx context.Context, formats strfmt.Registry) error {
