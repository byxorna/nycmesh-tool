...
func (m *SiteDescription1) validateDeviceListStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteDescription1TypeDeviceListStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteDescription1) validateIPAddresses(formats strfmt.Registry) error {
	...
	if err := m.IPAddresses.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("ipAddresses")
		}
		return err
	}
...
func (m *SiteDescription1) validateRegulatoryDomainEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteDescription1TypeRegulatoryDomainPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteDescription1) contextValidateContact(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteDescription1) contextValidateEndpoints(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SiteDescription1) contextValidateIPAddresses(ctx context.Context, formats strfmt.Registry) error {

	if err := m.IPAddresses.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("ipAddresses")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("ipAddresses")
...
func (m *SiteDescription1) contextValidateLocation(ctx context.Context, formats strfmt.Registry) error {
