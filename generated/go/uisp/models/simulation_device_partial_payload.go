...
func (m *SimulationDevicePartialPayload) validateApTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeApTypePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateChannelWidthEnum(path, location string, value float64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeChannelWidthPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateCoverageCpeHeightEnum(path, location string, value float64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeCoverageCpeHeightPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateEirpEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeEirpPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateFrequencyEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeFrequencyPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateHeightEnum(path, location string, value float64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeHeightPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateRadiusEnum(path, location string, value float64) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeRadiusPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) validateRoleEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, simulationDevicePartialPayloadTypeRolePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SimulationDevicePartialPayload) contextValidateAntenna(ctx context.Context, formats strfmt.Registry) error {
