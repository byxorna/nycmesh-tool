...
func (m *Wifi5Ghz) validateAuthenticationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi5GhzTypeAuthenticationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wifi5Ghz) validateEncryptionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi5GhzTypeEncryptionPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *Wifi5Ghz) validateModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, wifi5GhzTypeModePropEnum, true); err != nil {
		return err
	}
	return nil
}
