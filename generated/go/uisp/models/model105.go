...
var model105TypeAuthPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		model105TypeAuthPropEnum = append(model105TypeAuthPropEnum, v)
	}
}
...
// prop value enum
func (m *Model105) validateAuthEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, model105TypeAuthPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Model105) validateAuth(formats strfmt.Registry) error {
...
func (m *Model105) validateAuthKeysMD5(formats strfmt.Registry) error {
...
func (m *Model105) validateCost(formats strfmt.Registry) error {
...
func (m *Model105) contextValidateAuthKeysMD5(ctx context.Context, formats strfmt.Registry) error {
