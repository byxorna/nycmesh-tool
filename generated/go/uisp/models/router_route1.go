...
func (m *RouterRoute1) validateDescription(formats strfmt.Registry) error {
...
func (m *RouterRoute1) validateDestination(formats strfmt.Registry) error {
...
func (m *RouterRoute1) validateDistance(formats strfmt.Registry) error {
...
var routerRoute1TypeStaticTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		routerRoute1TypeStaticTypePropEnum = append(routerRoute1TypeStaticTypePropEnum, v)
	}
}
...
// prop value enum
func (m *RouterRoute1) validateStaticTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, routerRoute1TypeStaticTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *RouterRoute1) validateStaticType(formats strfmt.Registry) error {
