...
func (m *SiteTrafficShaping1) validateAggregation(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("aggregation", "body", *m.Aggregation, 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("aggregation", "body", *m.Aggregation, 10000, false); err != nil {
		return err
	}
...
func (m *SiteTrafficShaping1) validateDownloadBurstSizeEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShaping1TypeDownloadBurstSizePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping1) validateDownloadBurstSize(formats strfmt.Registry) error {
	...
	if err := validate.MaximumInt("downloadBurstSize", "body", *m.DownloadBurstSize, 1.024e+11, false); err != nil {
		return err
	}
...
func (m *SiteTrafficShaping1) validateDownloadSpeedEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShaping1TypeDownloadSpeedPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping1) validateDownloadSpeed(formats strfmt.Registry) error {
	...
	if err := validate.MaximumInt("downloadSpeed", "body", *m.DownloadSpeed, 1e+11, false); err != nil {
		return err
	}
...
func (m *SiteTrafficShaping1) validatePropagationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShaping1TypePropagationPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping1) validateUploadBurstSizeEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShaping1TypeUploadBurstSizePropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping1) validateUploadBurstSize(formats strfmt.Registry) error {
	...
	if err := validate.MaximumInt("uploadBurstSize", "body", *m.UploadBurstSize, 1.024e+11, false); err != nil {
		return err
	}
...
func (m *SiteTrafficShaping1) validateUploadSpeedEnum(path, location string, value int64) error {
	if err := validate.EnumCase(path, location, value, siteTrafficShaping1TypeUploadSpeedPropEnum, true); err != nil {
		return err
	}
	return nil
}
...
func (m *SiteTrafficShaping1) validateUploadSpeed(formats strfmt.Registry) error {
	...
	if err := validate.MaximumInt("uploadSpeed", "body", *m.UploadSpeed, 1e+11, false); err != nil {
		return err
	}
