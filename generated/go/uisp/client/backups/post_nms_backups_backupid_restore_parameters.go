...
// NewPostNmsBackupsBackupidRestoreParams creates a new PostNmsBackupsBackupidRestoreParams object,
...
func NewPostNmsBackupsBackupidRestoreParams() *PostNmsBackupsBackupidRestoreParams {
	return &PostNmsBackupsBackupidRestoreParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostNmsBackupsBackupidRestoreParamsWithTimeout creates a new PostNmsBackupsBackupidRestoreParams object
...
// NewPostNmsBackupsBackupidRestoreParamsWithContext creates a new PostNmsBackupsBackupidRestoreParams object
...
// NewPostNmsBackupsBackupidRestoreParamsWithHTTPClient creates a new PostNmsBackupsBackupidRestoreParams object
...
func (o *PostNmsBackupsBackupidRestoreParams) WithDefaults() *PostNmsBackupsBackupidRestoreParams {
	o.SetDefaults()
	return o
}
...
func (o *PostNmsBackupsBackupidRestoreParams) WithTimeout(timeout time.Duration) *PostNmsBackupsBackupidRestoreParams {
...
func (o *PostNmsBackupsBackupidRestoreParams) WithContext(ctx context.Context) *PostNmsBackupsBackupidRestoreParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the post nms backups backupid restore params
func (o *PostNmsBackupsBackupidRestoreParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the post nms backups backupid restore params
func (o *PostNmsBackupsBackupidRestoreParams) WithHTTPClient(client *http.Client) *PostNmsBackupsBackupidRestoreParams {
...
func (o *PostNmsBackupsBackupidRestoreParams) WithBackupID(backupID string) *PostNmsBackupsBackupidRestoreParams {
...
func (o *PostNmsBackupsBackupidRestoreParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
