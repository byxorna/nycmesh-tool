...
func (o *GetNmsSummaryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.LogsLevel != nil {
		...
		// binding items for logsLevel
		joinedLogsLevel := o.bindParamLogsLevel(reg)
...
// bindParamGetNmsSummary binds the parameter logsLevel
func (o *GetNmsSummaryParams) bindParamLogsLevel(formats strfmt.Registry) []string {
	logsLevelIR := o.LogsLevel

	var logsLevelIC []string
	for _, logsLevelIIR := range logsLevelIR { // explode []string

		logsLevelIIV := logsLevelIIR // string as string
		logsLevelIC = append(logsLevelIC, logsLevelIIV)
	}

	// items.CollectionFormat: "multi"
	logsLevelIS := swag.JoinByFormat(logsLevelIC, "multi")
