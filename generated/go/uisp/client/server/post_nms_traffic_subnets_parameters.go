...
func (o *PostNmsTrafficSubnetsParams) WithDefaults() *PostNmsTrafficSubnetsParams {
	o.SetDefaults()
	return o
}
...
func (o *PostNmsTrafficSubnetsParams) WithBody(body models.Model88) *PostNmsTrafficSubnetsParams {
	o.SetBody(body)
	return o
}
