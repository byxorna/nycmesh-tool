...
/* PutDevicesDeviceidInterfacesInterfacenameOK describes a response with status code 200, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesDeviceidInterfacesInterfacenameInternalServerError describes a response with status code 500, with default header values.
