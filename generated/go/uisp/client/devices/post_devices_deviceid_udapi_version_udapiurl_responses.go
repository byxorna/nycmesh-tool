...
/* PostDevicesDeviceidUdapiVersionUdapiurlOK describes a response with status code 200, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlInternalServerError describes a response with status code 500, with default header values.
...
/* PostDevicesDeviceidUdapiVersionUdapiurlNotImplemented describes a response with status code 501, with default header values.
