...
/* PutDevicesEroutersIDRouterRoutesOK describes a response with status code 200, with default header values.
...
/* PutDevicesEroutersIDRouterRoutesBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesEroutersIDRouterRoutesUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesEroutersIDRouterRoutesForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesEroutersIDRouterRoutesNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesEroutersIDRouterRoutesInternalServerError describes a response with status code 500, with default header values.
