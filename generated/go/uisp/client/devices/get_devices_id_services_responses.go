...
/* GetDevicesIDServicesOK describes a response with status code 200, with default header values.
...
/* GetDevicesIDServicesBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesIDServicesUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesIDServicesForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesIDServicesNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesIDServicesInternalServerError describes a response with status code 500, with default header values.
