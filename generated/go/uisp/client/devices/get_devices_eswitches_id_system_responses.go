...
/* GetDevicesEswitchesIDSystemOK describes a response with status code 200, with default header values.
...
func (o *GetDevicesEswitchesIDSystemOK) GetPayload() *models.Model41 {
	return o.Payload
}
...
/* GetDevicesEswitchesIDSystemBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEswitchesIDSystemUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEswitchesIDSystemForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEswitchesIDSystemNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEswitchesIDSystemInternalServerError describes a response with status code 500, with default header values.
