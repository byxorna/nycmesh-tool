...
/* PutDevicesSolarbeamsIDConfigSystemParams contains all the parameters to send to the API endpoint
   for the put devices solarbeams Id config system operation.
...
// WithDefaults hydrates default values in the put devices solarbeams Id config system params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesSolarbeamsIDConfigSystemParams) WithDefaults() *PutDevicesSolarbeamsIDConfigSystemParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put devices solarbeams Id config system params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesSolarbeamsIDConfigSystemParams) SetDefaults() {
...
func (o *PutDevicesSolarbeamsIDConfigSystemParams) WithBody(body *models.Model55) *PutDevicesSolarbeamsIDConfigSystemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices solarbeams Id config system params
func (o *PutDevicesSolarbeamsIDConfigSystemParams) SetBody(body *models.Model55) {
	o.Body = body
}
