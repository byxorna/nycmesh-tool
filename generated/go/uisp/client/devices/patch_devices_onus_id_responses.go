...
/* PatchDevicesOnusIDOK describes a response with status code 200, with default header values.
...
/* PatchDevicesOnusIDBadRequest describes a response with status code 400, with default header values.
...
/* PatchDevicesOnusIDUnauthorized describes a response with status code 401, with default header values.
...
/* PatchDevicesOnusIDForbidden describes a response with status code 403, with default header values.
...
/* PatchDevicesOnusIDNotFound describes a response with status code 404, with default header values.
...
/* PatchDevicesOnusIDInternalServerError describes a response with status code 500, with default header values.
