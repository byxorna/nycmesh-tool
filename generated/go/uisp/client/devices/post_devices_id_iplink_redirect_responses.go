...
/* PostDevicesIDIplinkRedirectOK describes a response with status code 200, with default header values.
...
/* PostDevicesIDIplinkRedirectBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesIDIplinkRedirectUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesIDIplinkRedirectForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesIDIplinkRedirectInternalServerError describes a response with status code 500, with default header values.
