...
/* GetDevicesDeviceidUdapiVersionUdapiurlOK describes a response with status code 200, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlInternalServerError describes a response with status code 500, with default header values.
...
/* GetDevicesDeviceidUdapiVersionUdapiurlNotImplemented describes a response with status code 501, with default header values.
