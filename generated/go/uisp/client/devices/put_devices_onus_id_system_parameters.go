...
/* PutDevicesOnusIDSystemParams contains all the parameters to send to the API endpoint
   for the put devices onus Id system operation.
...
// WithDefaults hydrates default values in the put devices onus Id system params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesOnusIDSystemParams) WithDefaults() *PutDevicesOnusIDSystemParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put devices onus Id system params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutDevicesOnusIDSystemParams) SetDefaults() {
...
func (o *PutDevicesOnusIDSystemParams) WithBody(body *models.Model115) *PutDevicesOnusIDSystemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put devices onus Id system params
func (o *PutDevicesOnusIDSystemParams) SetBody(body *models.Model115) {
	o.Body = body
}
