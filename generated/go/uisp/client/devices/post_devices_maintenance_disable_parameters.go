...
/* PostDevicesMaintenanceDisableParams contains all the parameters to send to the API endpoint
   for the post devices maintenance disable operation.
...
// WithDefaults hydrates default values in the post devices maintenance disable params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostDevicesMaintenanceDisableParams) WithDefaults() *PostDevicesMaintenanceDisableParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post devices maintenance disable params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostDevicesMaintenanceDisableParams) SetDefaults() {
