...
/* PostDevicesOnusIDResetstatsOK describes a response with status code 200, with default header values.
...
/* PostDevicesOnusIDResetstatsBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesOnusIDResetstatsUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesOnusIDResetstatsForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesOnusIDResetstatsNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesOnusIDResetstatsInternalServerError describes a response with status code 500, with default header values.
