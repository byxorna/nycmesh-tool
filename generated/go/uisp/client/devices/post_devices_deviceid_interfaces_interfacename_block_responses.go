...
/* PostDevicesDeviceidInterfacesInterfacenameBlockOK describes a response with status code 200, with default header values.
...
/* PostDevicesDeviceidInterfacesInterfacenameBlockBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesDeviceidInterfacesInterfacenameBlockUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesDeviceidInterfacesInterfacenameBlockForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesDeviceidInterfacesInterfacenameBlockNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesDeviceidInterfacesInterfacenameBlockInternalServerError describes a response with status code 500, with default header values.
