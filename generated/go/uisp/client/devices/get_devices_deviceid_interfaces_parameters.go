...
/* GetDevicesDeviceidInterfacesParams contains all the parameters to send to the API endpoint
   for the get devices deviceid interfaces operation.
...
// WithDefaults hydrates default values in the get devices deviceid interfaces params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesDeviceidInterfacesParams) WithDefaults() *GetDevicesDeviceidInterfacesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get devices deviceid interfaces params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesDeviceidInterfacesParams) SetDefaults() {
