...
/* GetDevicesDiscoveredOK describes a response with status code 200, with default header values.
...
/* GetDevicesDiscoveredBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesDiscoveredUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesDiscoveredForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesDiscoveredInternalServerError describes a response with status code 500, with default header values.
