...
/* DeleteDevicesIDOK describes a response with status code 200, with default header values.
...
/* DeleteDevicesIDBadRequest describes a response with status code 400, with default header values.
...
/* DeleteDevicesIDUnauthorized describes a response with status code 401, with default header values.
...
/* DeleteDevicesIDForbidden describes a response with status code 403, with default header values.
...
/* DeleteDevicesIDInternalServerError describes a response with status code 500, with default header values.
