...
/* GetDevicesEroutersIDRouterOspfOK describes a response with status code 200, with default header values.
...
/* GetDevicesEroutersIDRouterOspfBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEroutersIDRouterOspfUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEroutersIDRouterOspfForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEroutersIDRouterOspfNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEroutersIDRouterOspfInternalServerError describes a response with status code 500, with default header values.
