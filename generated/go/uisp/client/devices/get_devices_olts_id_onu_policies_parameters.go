...
/* GetDevicesOltsIDOnuPoliciesParams contains all the parameters to send to the API endpoint
   for the get devices olts Id onu policies operation.
...
// WithDefaults hydrates default values in the get devices olts Id onu policies params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesOltsIDOnuPoliciesParams) WithDefaults() *GetDevicesOltsIDOnuPoliciesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get devices olts Id onu policies params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesOltsIDOnuPoliciesParams) SetDefaults() {
