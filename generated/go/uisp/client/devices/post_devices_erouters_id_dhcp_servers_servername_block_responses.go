...
/* PostDevicesEroutersIDDhcpServersServernameBlockOK describes a response with status code 200, with default header values.
...
/* PostDevicesEroutersIDDhcpServersServernameBlockBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesEroutersIDDhcpServersServernameBlockUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesEroutersIDDhcpServersServernameBlockForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesEroutersIDDhcpServersServernameBlockNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesEroutersIDDhcpServersServernameBlockInternalServerError describes a response with status code 500, with default header values.
