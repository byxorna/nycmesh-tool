...
/* GetDevicesOnusIDWirelessOK describes a response with status code 200, with default header values.
...
/* GetDevicesOnusIDWirelessBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesOnusIDWirelessUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesOnusIDWirelessForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesOnusIDWirelessNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesOnusIDWirelessInternalServerError describes a response with status code 500, with default header values.
...
/* GetDevicesOnusIDWirelessNotImplemented describes a response with status code 501, with default header values.
