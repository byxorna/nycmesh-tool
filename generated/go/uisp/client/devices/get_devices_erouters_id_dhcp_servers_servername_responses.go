...
/* GetDevicesEroutersIDDhcpServersServernameOK describes a response with status code 200, with default header values.
...
/* GetDevicesEroutersIDDhcpServersServernameBadRequest describes a response with status code 400, with default header values.
...
/* GetDevicesEroutersIDDhcpServersServernameUnauthorized describes a response with status code 401, with default header values.
...
/* GetDevicesEroutersIDDhcpServersServernameForbidden describes a response with status code 403, with default header values.
...
/* GetDevicesEroutersIDDhcpServersServernameNotFound describes a response with status code 404, with default header values.
...
/* GetDevicesEroutersIDDhcpServersServernameInternalServerError describes a response with status code 500, with default header values.
