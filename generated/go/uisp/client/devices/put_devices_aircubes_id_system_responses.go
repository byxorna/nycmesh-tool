...
/* PutDevicesAircubesIDSystemOK describes a response with status code 200, with default header values.
...
/* PutDevicesAircubesIDSystemBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesAircubesIDSystemUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesAircubesIDSystemForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesAircubesIDSystemNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesAircubesIDSystemInternalServerError describes a response with status code 500, with default header values.
