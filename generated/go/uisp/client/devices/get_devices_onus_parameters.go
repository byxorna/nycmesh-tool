...
/* GetDevicesOnusParams contains all the parameters to send to the API endpoint
   for the get devices onus operation.
...
// WithDefaults hydrates default values in the get devices onus params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesOnusParams) WithDefaults() *GetDevicesOnusParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get devices onus params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetDevicesOnusParams) SetDefaults() {
