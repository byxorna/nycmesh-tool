...
/* DeleteDevicesIDParams contains all the parameters to send to the API endpoint
   for the delete devices Id operation.
...
// WithDefaults hydrates default values in the delete devices Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDevicesIDParams) WithDefaults() *DeleteDevicesIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete devices Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteDevicesIDParams) SetDefaults() {
