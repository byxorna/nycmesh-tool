...
/* PostDevicesIDUpdateOK describes a response with status code 200, with default header values.
...
/* PostDevicesIDUpdateBadRequest describes a response with status code 400, with default header values.
...
/* PostDevicesIDUpdateUnauthorized describes a response with status code 401, with default header values.
...
/* PostDevicesIDUpdateForbidden describes a response with status code 403, with default header values.
...
/* PostDevicesIDUpdateNotFound describes a response with status code 404, with default header values.
...
/* PostDevicesIDUpdateInternalServerError describes a response with status code 500, with default header values.
