...
/* PutDevicesAircubesIDConfigSystemOK describes a response with status code 200, with default header values.
...
/* PutDevicesAircubesIDConfigSystemBadRequest describes a response with status code 400, with default header values.
...
/* PutDevicesAircubesIDConfigSystemUnauthorized describes a response with status code 401, with default header values.
...
/* PutDevicesAircubesIDConfigSystemForbidden describes a response with status code 403, with default header values.
...
/* PutDevicesAircubesIDConfigSystemNotFound describes a response with status code 404, with default header values.
...
/* PutDevicesAircubesIDConfigSystemInternalServerError describes a response with status code 500, with default header values.
